...
export const Collections = (props: {
  ...
  return (
    <div className="capitalize my-10 border-t-2 border-dashed border-base-content pt-2">
      <h2 className="collections-heading text-white bg-secondary p-6 shadow-xl rounded-2xl mx-5">
