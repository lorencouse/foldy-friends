  ...
  return (
    <div className='lg:w-11/12 m-auto'>
        ...
        <div className="sort-by flex flex-row justify-between items-center ">
            <p><span className='font-extrabold'>Showing 1-12</span> out of 36 products</p>
                <button className='rounded-full w-48 text-black p-3 bg-white hover:bg-gray-500 outline outline-1 outline-gray-400 my-10' >Sort By</button>
        </div>
